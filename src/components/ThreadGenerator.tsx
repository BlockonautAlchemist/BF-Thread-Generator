    ...
    <div>
      ...
      <div className="mb-4">
        <textarea
          ...
          placeholder="Example: Boss Fighters is an asymmetric multiplayer VR vs. PC game where one player takes on the role of a massive, powerful boss in VR, while others play as agile PC-based fighters trying to take it down. The game features..."
